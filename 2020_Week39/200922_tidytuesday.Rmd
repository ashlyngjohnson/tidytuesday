...
Note: there's an issue here. The number of injuries showing up on the plot is far less than what shows up when I use the count function. Unclear what is going on. 
